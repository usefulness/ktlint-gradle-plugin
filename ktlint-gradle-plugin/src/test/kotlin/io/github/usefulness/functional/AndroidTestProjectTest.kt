...
internal class AndroidTestProjectTest : WithGradleTest.Android() {

    private lateinit var testModuleRoot: File
    ...
    fun setUp() {
        testProjectDir.apply {
            ...
            testModuleRoot = resolve("androidproject") {
                resolve("build.gradle") {
                    // language=groovy
                    val androidBuildScript =
                        ...
                        android {
                            ...
                            namespace 'io.github.usefulness.test'
                            compileSdk 36
                            defaultConfig {
                                minSdkVersion 32
                            }
